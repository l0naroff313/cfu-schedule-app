...
- отдельные локальные заметки с кнопкой «+» и сохранением в SQLite;
- экран настроек с системной, светлой и тёмной темами;
...
2. Довести все пять вкладок до финальных дизайн-досок, включая состояния загрузки, пустые состояния и адаптивность.
3. Связать заметки и домашние задания с конкретными занятиями и добавить редактирование/удаление.
4. Добавить локальную очередь синхронизации, серверный API, PostgreSQL и установочную идентичность без экрана входа.
5. Реализовать уведомления, провести accessibility/UI-тесты на Android и iOS и подготовить release-сборки.
