...
Актуальная версия — **КФУ ЭлЖур v1.0.10**.
...
| --- | --- | --- |
| Android | APK v1.0.10 | [Скачать CFU-ElJournal-Android.apk](https://github.com/l0naroff313/cfu-schedule-app/releases/download/v1.0.10/CFU-ElJournal-Android.apk) |
| iPhone и iPad | PWA v1.0.10 | [Открыть текущую PWA](https://cfu-eljournal-l0naroff313.pages.dev/) |
