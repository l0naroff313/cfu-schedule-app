...
Актуальная публичная версия — **КФУ ЭлЖур v1.0.9**.
...
| --- | --- | --- |
| Android | APK v1.0.9 | [Скачать CFU-ElJournal-Android.apk](https://github.com/l0naroff313/cfu-schedule-app/releases/download/v1.0.9/CFU-ElJournal-Android.apk) |
| iPhone и iPad | PWA v1.0.9 | [Открыть текущую PWA](https://cfu-eljournal-l0naroff313.pages.dev/) |
